    ...
    return (
        <>
                                    ...
                                    <input
                                        ...
                                        className="w-40 shadow-md sm:w-96 shadow-white h-12 rounded-md bg-transparent text-xl pl-10 absolute top-4 right-3 pr-4"
            ...
            <div className="m-2 relative">
                ...
                />
                <span
                    onClick={editIndex !== null ? saveEdit : handleAddTodo}
